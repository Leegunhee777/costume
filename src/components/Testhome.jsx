            ...
            items : [
                {
                    ...
                    src: "https://swcap02.s3.ap-northeast-2.amazonaws.com/product/%ED%81%AC%EB%A6%BC%EC%95%84%EC%9D%B4%EB%B3%B4%EB%A6%AC.png"
                ...
                },
                {
                    ...
                    name: 'giraffe',
                    desc: '길다란목',
                    src:"https://swcap02.s3.ap-northeast-2.amazonaws.com/product/%EB%B8%94%EB%9E%99-13.png"
    ...
    render() {
        return (
            ...
            return <span  key = {c.id}> {c.id} <img src= {c.src}/> </span>
                ...
                <button onClick={this.gochart} >차트보기</button>
                <button onClick={this.gotrade}>제휴컴포넌트</button>
                <button onClick={this.goPay}>결제하기</button>
